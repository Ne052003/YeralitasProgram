...
import controladores.ControladorConsultasCli;
...
public class ConsultasCli_JFrame extends javax.swing.JFrame {
  ...
  private final ControladorConsultasCli ConsultaCli;
  ...
  public ConsultasCli_JFrame() {
    ...
    ConsultaCli = new ControladorConsultasCli(this);
  ...
  private void initComponents() {
    ...
    combox_filtro.setModel(
        new javax.swing.DefaultComboBoxModel<>(new String[] {"Nombre", "ID", "Número celular"}));
    combox_filtro.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    combox_consulta.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {"--Seleccione--", "Consultas - Ventas", "Inventario"}));
    ...
    table_cli.setModel(
        new javax.swing.table.DefaultTableModel(
            ...
            new String[] {"ID", "Nombre", "Número celular", "Dirección"}) {
          Class[] types =
              new Class[] {
  ...
  private void combox_filtroActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_combox_filtroActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_combox_filtroActionPerformed

  private void txt_datoActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_txt_datoActionPerformed
    // TODO add your handling code here:
  ...
  private void jButton2ActionPerformed(
    ...
    MetodosGenerales.abrirVentana(new Eliminar_JFrame());
    this.dispose();
  ...
  private void btn_buscarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btn_buscarActionPerformed
    // TODO add your handling code here:
