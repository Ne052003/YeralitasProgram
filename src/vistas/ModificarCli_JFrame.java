...
public class ModificarCli_JFrame extends javax.swing.JFrame {
  ...
  public ModificarCli_JFrame() {
    ...
    if (Login.getRol().equals("gerente")) {
      combox_modificar.addItem("Modificar - Manufactura");
      combox_modificar.addItem("Modificar - Empleado");

    } else if (Login.getRol().equals("administrador")) {
      combox_modificar.addItem("Modificar - Manufactura");
      combox_modificar.addItem("Modificar - Gerente");
      combox_modificar.addItem("Modificar - Empleado");
      combox_modificar.addItem("Modificar - Area");
    }
  }
  ...
  private void initComponents() {
    ...
    combox_modificar.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jButton_Guardar.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    jTextField_Celular.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    btn_Consultar.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void combox_modificarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_combox_modificarActionPerformed
    // TODO add your handling code here:
    String seleccionado = combox_modificar.getSelectedItem().toString();
    switch (seleccionado) {
      case "Modificar - Empleado" -> {
        abrirVentana(new Modificar_JFrame());
        this.dispose();
      }
      case "Modificar - Producto" -> {
        abrirVentana(new ModificarPro_JFrame());
        this.dispose();
      }
      case "Modificar - Observación" -> {
        abrirVentana(new ModificarObs_JFrame());
        this.dispose();
      }
      case "Modificar - Venta" -> {
        abrirVentana(new ModificarVen_JFrame());
        this.dispose();
      }
      case "Modificar - Manufactura" -> {
        JOptionPane.showMessageDialog(null, "There is no window for this option");
        this.dispose();
      }
      case "Modificar - Gerente" -> {
        abrirVentana(new Modificar_JFrame());
        this.dispose();
      }
    }
  ...
  private void jTextField_CelularActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jTextField_CelularActionPerformed
    // TODO add your handling code here:
  ...
  private void jButton_GuardarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButton_GuardarActionPerformed
    // TODO add your handling code here:
  } // GEN-LAST:event_jButton_GuardarActionPerformed

  private void btn_agregarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btn_agregarActionPerformed
    // TODO add your handling code here:
  ...
  private void btn_ConsultarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btn_ConsultarActionPerformed
    // TODO add your handling code here:
