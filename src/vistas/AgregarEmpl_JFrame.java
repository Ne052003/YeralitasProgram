...
public class AgregarEmpl_JFrame extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    txt_identificacion.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    combox_gerente.setModel(
        new javax.swing.DefaultComboBoxModel<>(new String[] {"1001580622", "1038336539"}));
    combox_gerente.setPreferredSize(new java.awt.Dimension(175, 20));

    combox_area.setModel(
    ...
    combox_registros.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {
              ...
              "Registro de manufacturas"
            }));
    combox_registros.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jButton_VolverActionPerformed(
    ...
    MenuEmpl_JFrame.getMenu();
    this.dispose();
  } // GEN-LAST:event_jButton_VolverActionPerformed

  private void txt_celularActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_txt_celularActionPerformed
    // TODO add your handling code here:
  ...
  private void combox_registrosActionPerformed(
    ...
    switch (seleccionado) {
      case "Registro de areas" -> {
        MetodosGenerales.abrirVentana(new AgregarArea_JFrame());
        this.dispose();
      }
      case "Registro de gerentes" -> {
        MetodosGenerales.abrirVentana(new AgregarGeren_JFrame());
        this.dispose();
      }
      ...
      case "Registro de productos" -> {
        MetodosGenerales.abrirVentana(new AgregarPro_JFrame());
        this.dispose();
      }
      case "Registro de observaciones" -> {
        MetodosGenerales.abrirVentana(new AgregarObs_JFrame());
        this.dispose();
      }
      ...
      case "Registro de manufacturas" -> {
        MetodosGenerales.abrirVentana(new AgregarManu_JFrame());
        this.dispose();
      }
    }
  ...
  private void txt_identificacionActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_txt_identificacionActionPerformed
    // TODO add your handling code here:
