...
public class Soporte_JFrame extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel2.setText(
        "<html>En caso de que el programa no siga su correcto funcionamiento y se presente invonvenientes <br/> para navegar  \npor la página, puede contactarse con el área encargada por los siguientes medios:</html>");

    jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
    jLabel3.setForeground(new java.awt.Color(255, 255, 255));
    jLabel3.setText(
        "<html>Tel: 01-800-465-321 <br/>Cel: 3232864548<br/> Correo: Yeralitas@hotmail.com</html> ");
