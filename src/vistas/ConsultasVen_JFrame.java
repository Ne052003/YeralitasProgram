...
import controladores.ControladorConsultasVenta;
...
public class ConsultasVen_JFrame extends javax.swing.JFrame {
  ...
  public ConsultasVen_JFrame() {
    ...
    ControladorConsultasVenta consuVen = new ControladorConsultasVenta(this);
  ...
  private void initComponents() {
    ...
    combox_filtro.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {"ID Empleado", "ID Cliente", "ID Manufactura", "Fecha", "Precio"}));
    ...
    combox_consulta.setModel(
        new javax.swing.DefaultComboBoxModel<>(
            new String[] {"--Seleccione--", "Consultas - Clientes", "Inventario"}));
  ...
  private void jButton3ActionPerformed(
    ...
    MetodosGenerales.abrirVentana(new ModificarVen_JFrame());
