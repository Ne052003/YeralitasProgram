...
public class ModificarObs_JFrame extends javax.swing.JFrame {
  ...
  private void combox_modificarActionPerformed(
    ...
    switch (seleccionado) {
      case "Modificar - Cliente" -> {
        abrirVentana(new ModificarCli_JFrame());
        this.dispose();
      }
      ...
      case "Modificar - Manufactura" -> JOptionPane.showMessageDialog(
          null, "There is no window for this option still");
      case "Modificar - Gerente" -> JOptionPane.showMessageDialog(
          null, "There is no window for this option still");
    }
  ...
  private void jComboBox_AreaActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jComboBox_AreaActionPerformed
    // TODO add your handling code here:
